...
{
    document.getElementById('nameer').innerText = "User";
}
else{
...
function man() {
    document.querySelector('.boot').innerHTML = `    <br><br><br><br><br>
        <img class="userimage" src="./images/user.png" width="180px" alt=""><br><br><h3 id="nameer">`+localStorage.getItem('name')+`</h3><br><br>
    <br><br>
...
function unlockr() {
    if (document.getElementById('pass').value == localStorage.getItem('pass'))
    {
        ...
        start_s = new Audio('../assets/startup.mp3');
        start_s.play()
        notify("Hello, "+localStorage.getItem('name'), 4000);
    }
    else if (localStorage.getItem('pass') == null)
    {
        document.querySelector('.boot').style = "visibility: hidden;";        
        start_s = new Audio('../assets/startup_sound.mp3');
        start_s.play()
        notify("Hello, "+localStorage.getItem('name'), 4000);
    }
    else
